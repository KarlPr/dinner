        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaseUnit = table.Column<string>(type: "TEXT", maxLength: 10, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IngredientPackages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IngredientPackages_Ingredients_IngredientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IngredientPackages_IngredientId",
                table: "IngredientPackages",
                column: "IngredientId");
